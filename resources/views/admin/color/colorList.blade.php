...
<div class="row">
    <div class="col-md-12">
      <a href="{{ url('/color/add') }}"><button class="btn btn-sm btn-danger pull-right">Add New Color</button></a>
    </div>
</div>
                    ...
                    <table class="table rable-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/color/editColor/'.$color->colorId)  }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ url('/color/deleteColor/'.$color->colorId)  }}" onclick="return confirm('Are You Sure !');">
