...
<div class="row">
    <div class="col-md-12">
      <a href="{{ url('/size/add') }}"><button class="btn btn-sm btn-danger pull-right">Add New Size</button></a>
    </div>
</div>
                    ...
                    <table class="table rable-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $size->sizeName }}</td>
                                <td>
                                    <a href="{{ url('/size/editSize/'.$size->sizeId)  }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ url('/size/deleteSize/'.$size->sizeId)  }}" onclick="return confirm('Are You Sure !');">
